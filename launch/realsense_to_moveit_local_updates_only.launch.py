...
def generate_launch_description():
    ...
    realsense_to_moveit_local_updates_only_node = Node(
        name="realsense_to_moveit_local_updates_only_node",
        package="arctos_motion_planning",
        executable="realsense_to_moveit_local_updates_only_node",
        output="screen",
        parameters=[
